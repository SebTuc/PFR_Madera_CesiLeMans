...
<body>
    ...
    <div role="main" class="container">
	     ...
	     <div class="row">
			...
			<div class="col-sm-6 col-md-4">
				<button onclick="window.location.href = 'DevisFacture';" class="btn-modularis btn-modularis-hover"><i class="material-icons md-48">library_books</i> <br/>Devis / Facture / Projet</button>
			</div>
			<div class="col-sm-6 col-md-4">
			...
			<div class="col-sm-6 col-md-4">
				<button onclick="window.location.href = 'GestionStock/ListEntrepot';" class="btn-modularis btn-modularis-hover"><i class="material-icons md-48">search</i> <br/>Gestion Stock</button>
			</div>
			<div class="col-sm-6 col-md-4">
