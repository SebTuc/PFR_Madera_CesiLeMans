	...
	<div class="login-page">
		<div class="form">
			...
			<form method="post" class="login-form">
				...
				<div class="flex-row">
					<input type="checkbox" class="form-check-input" id="addToCookie"
						name="addToCookie" style="margin-top:9px;"/>
					<label class="form-check-label" for="addToCookie" style="color:white;margin-bottom:10px;">Se souvenir de moi</label>
				</div>
