...
ALTER TABLE STOCK ADD CONSTRAINT FK_STOCK_COMPOSANT_ID FOREIGN KEY (COMPOSANT_ID) REFERENCES COMPOSANT(COMPOSANT_ID);
ALTER TABLE FACTURE ADD CONSTRAINT FK_FACTURE_DEVIS_ID FOREIGN KEY (DEVIS_ID) REFERENCES DEVIS(DEVIS_ID);
ALTER TABLE FACTURE ADD CONSTRAINT FK_FACTURE_ETAPE_FACTURE_ID FOREIGN KEY (ETAPE_FACTURE_ID) REFERENCES ETAPE_FACTURE(ETAPE_FACTURE_ID);
...
ALTER TABLE UTILISATEUR ADD CONSTRAINT FK_UTILISATEUR_ENTREPOT_ID FOREIGN KEY (ENTREPOT_ID) REFERENCES ENTREPOT(ENTREPOT_ID);
...
ALTER TABLE `composant` CHANGE `DISPLAY` `DISPLAY` TINYINT(1) NULL DEFAULT '1';
ALTER TABLE `module` CHANGE `DISPLAY` `DISPLAY` TINYINT(1) NULL DEFAULT '1';
ALTER TABLE `projet` CHANGE `IS_CLONE` `IS_CLONE` TINYINT(1) NULL DEFAULT '0';