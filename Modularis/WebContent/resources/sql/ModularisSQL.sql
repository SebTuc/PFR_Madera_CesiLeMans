...
CREATE TABLE UNITE_MESURE(
        UNITE_ID  int (11) Auto_increment  NOT NULL ,
        NOM_UNITE Varchar (25) NOT NULL ,
...
ALTER TABLE PROJET ADD CONSTRAINT FK_PROJET_CATALOGUE_ID FOREIGN KEY (CATALOGUE_ID) REFERENCES CATALOGUE(CATALOGUE_ID);
ALTER TABLE PLAN ADD CONSTRAINT FK_PLAN_PROJET_ID FOREIGN KEY (PROJET_ID) REFERENCES PROJET(PROJET_ID);
ALTER TABLE MODULE ADD CONSTRAINT FK_MODULE_PIECE_ID FOREIGN KEY (PIECE_ID) REFERENCES PIECE(PIECE_ID);
...
ALTER TABLE COMPOSANT ADD CONSTRAINT FK_COMPOSANT_UNITE_ID FOREIGN KEY (UNITE_ID) REFERENCES UNITE_MESURE(UNITE_ID);
