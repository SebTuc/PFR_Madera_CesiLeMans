		...
		if( btnEditer != null && composantId != null) {
			...
			if(MethodeUtile.isInteger(composantId)) {
				...
				if(!composantService.composantInDevisOrCatalogue(composant)) {
					...
					request.setAttribute("Erreur", "Impossible de supprimer se composant, le composant est utilis� dans un ou plusieur devis/catalogue.");
...
//					composantService.editComposant(composant);
				...
				request.setAttribute("Erreur", "L'id est incorrect, si le probl�me persiste contacter le support.");
			}
