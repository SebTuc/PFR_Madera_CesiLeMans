...
public class MetierDelete extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String metierId = req.getParameter("buttonDelete");			
		
		if(metierId != null) {
			Metier metier = metierService.getMetierById(Integer.parseInt(metierId));
			req.setAttribute("metier", metier);
			req.getRequestDispatcher("/jsp/application/metier/deleteMetier.jsp").forward(req, resp);
		}else{
